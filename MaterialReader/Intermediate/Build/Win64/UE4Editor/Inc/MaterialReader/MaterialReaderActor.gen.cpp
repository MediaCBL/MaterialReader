...
// End Cross Module References
	DEFINE_FUNCTION(AMaterialReaderActor::execResetPropertys)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ResetPropertys();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AMaterialReaderActor::execInitConstruct)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->InitConstruct();
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMaterialReaderActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AMaterialReaderActor_InitConstruct, "InitConstruct" }, // 1950500346
		{ &Z_Construct_UFunction_AMaterialReaderActor_ResetPropertys, "ResetPropertys" }, // 2036108352
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AMaterialReaderActor_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UClass_AMaterialReaderActor_Statics::PropPointers),
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AMaterialReaderActor_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AMaterialReaderActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AMaterialReaderActor, 2953604376);
